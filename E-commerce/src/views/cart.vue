  ...
  <div class="cart">
    ...
    <div class="flex justify-evenly">
      <table>
        ...
        <tr class="h-48">
            <td><img alt="" class="h-48" src="@/assets/css/images/homepic/middle_shirt.svg" /></td>
            <td>
                <div class="number">
                <button class="minus" @click="decrease">-</button>
                <input value=""  min="1" max="5" type="number" step="1" name="quantity" id="quantity"  class="text-center">
                <button class="minus" @click="increase">+</button>
                </div>
            </td>
            <td>20USD</td>
